...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  chiefEditor.o editor.o makeup.o p_journalist.o printer.o register.o t_journalist.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
chiefEditor.o: /cygdrive/C/eclipse/workspace/test/chiefEditor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
editor.o: /cygdrive/C/eclipse/workspace/test/editor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
makeup.o: /cygdrive/C/eclipse/workspace/test/makeup.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
p_journalist.o: /cygdrive/C/eclipse/workspace/test/p_journalist.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
printer.o: /cygdrive/C/eclipse/workspace/test/printer.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/test/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
t_journalist.o: /cygdrive/C/eclipse/workspace/test/t_journalist.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
chiefEditor.o: /cygdrive/C/eclipse/workspace/test/chiefEditor.cpp \
 /cygdrive/C/eclipse/workspace/test/chiefEditor.h \
...
editor.o: /cygdrive/C/eclipse/workspace/test/editor.cpp \
 /cygdrive/C/eclipse/workspace/test/editor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
makeup.o: /cygdrive/C/eclipse/workspace/test/makeup.cpp \
 /cygdrive/C/eclipse/workspace/test/makeup.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
p_journalist.o: /cygdrive/C/eclipse/workspace/test/p_journalist.cpp \
 /cygdrive/C/eclipse/workspace/test/p_journalist.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
printer.o: /cygdrive/C/eclipse/workspace/test/printer.cpp \
 /cygdrive/C/eclipse/workspace/test/printer.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/test/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/test/p_journalist.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/test/t_journalist.h \
 /cygdrive/C/eclipse/workspace/test/printer.h \
 /cygdrive/C/eclipse/workspace/test/editor.h \
 /cygdrive/C/eclipse/workspace/test/makeup.h \
 /cygdrive/C/eclipse/workspace/test/chiefEditor.h
